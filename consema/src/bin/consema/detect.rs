...
//! the deterministic table below, pinned by this module's unit tests
//! (`cli.detection@1` executes at process level; the vector suite does not
//! contain a `cli.detection` capability — the runner rejects it).
